...
@section('title')
تقرير بالطلاب الغير مستلمين للشهادات
@endsection
...
@section('content')
                                    ...
                                    <div class="fltr-date-range-reg">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                id="dateRngFrm" class="form-control" />
                                            &nbsp;
                                            الي
                                            <input
                                                value='@if (app('request')->dateRngTo != null) {{ app('request')->dateRngTo }} @endif'
                                                id="dateRangTo" class="form-control" />
                                        </div>
    ...
    @push('scripts')
        <script>
            var url = '{{ url(Auth::getDefaultDriver() . '/reports/ReportStudentsNotReciveCert') }}';
        </script>
