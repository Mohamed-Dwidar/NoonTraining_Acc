                                                            ...
                                                            @if (!empty($branches))
                                                                @foreach ($branches as $branch)
                                                                    <option value="{{ $branch->id }}"
                                                                        @if (old('branch_id', $student->branch_id) == $branch->id) selected @endif>
                                                                        {{ $branch->name }}</option>
                                                                @endforeach
                                                            @endif
                                                        </select>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control hijri-datepicker"
                                                        id="id_expire_date" name="id_expire_date"
                                                        value="{{ old('id_expire_date', $student->id_expire_date) }}">
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-lg-2 col-sm-12 col-xs-12 col-2">
                                                ...
                                                <div class="form-group">
                                                    <select class="form-control" id="city_id" name="city_id">
                                                        <option></option>
                                                        <!-- This empty option is necessary for the placeholder to work -->
                                                        @if (!empty($cities))
                                            ...
                                            <div class="col-lg-5 col-sm-12 col-xs-12 col-6">
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="company"
                                                        name="company" value="{{ old('company', $student->company) }}">
                                                </div>
                                            </div>
                                        </div>
